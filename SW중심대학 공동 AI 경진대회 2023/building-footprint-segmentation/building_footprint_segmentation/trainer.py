...
class Trainer:
    ...
    def train(self, start_epoch, end_epoch, step: int = 0, bst_vld_loss: float = None):
        ...
        # scheduler  = StepLR(self.optimizer, step_size=4, gamma=0.1)
        scheduler = CosineAnnealingLR(self.optimizer, T_max=20, eta_min=0.0001)
    ...
    def state_train(
        ...
        for train_data in self.loader.train_loader:
            ...
            #print("ground_truth",(train_data["ground_truth"]))
